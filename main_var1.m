...
for  i = 1:trainIDX01
    X_train_tmp01(:,1,1,i) = mat2gray(abs(Dyn_var_CIR01(i,:))');
    X_train_tmp01(:,2,1,i) = mat2gray(abs(Bg_var_CIR01)');
end
for  i = 1:trainIDX02
    X_train_tmp02(:,1,1,i) = mat2gray(abs(Dyn_var_CIR02(i,:))');
    X_train_tmp02(:,2,1,i) = mat2gray(abs(Bg_var_CIR02)');
end
for  i = 1:trainIDX04
    X_train_tmp04(:,1,1,i) = mat2gray(abs(Dyn_var_CIR04(i,:))');
    X_train_tmp04(:,2,1,i) = mat2gray(abs(Bg_var_CIR04)');
end
for  i = 1:trainIDX12
    X_train_tmp12(:,1,1,i) = mat2gray(abs(Dyn_var_CIR12(i,:))');
    X_train_tmp12(:,2,1,i) = mat2gray(abs(Bg_var_CIR12)');
end
for  i = 1:trainIDX14
    X_train_tmp14(:,1,1,i) = mat2gray(abs(Dyn_var_CIR14(i,:))');
    X_train_tmp14(:,2,1,i) = mat2gray(abs(Bg_var_CIR14)');
end
for  i = 1:trainIDX24
    X_train_tmp24(:,1,1,i) = mat2gray(abs(Dyn_var_CIR24(i,:))');
...
%% test
CIR_tmp01 = Dyn_var_CIR01(trainIDX01+1:end,:);
CIR_tmp02 = Dyn_var_CIR02(trainIDX02+1:end,:);
CIR_tmp04 = Dyn_var_CIR04(trainIDX04+1:end,:);
CIR_tmp12 = Dyn_var_CIR12(trainIDX12+1:end,:);
CIR_tmp14 = Dyn_var_CIR14(trainIDX14+1:end,:);
CIR_tmp24 = Dyn_var_CIR24(trainIDX24+1:end,:);
