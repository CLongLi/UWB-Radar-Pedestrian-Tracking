...
for  i = 1:trainIDX01
    X_train_tmp01(:,1,1,i) = mat2gray(abs(Dyn_var_CIR01(trainSet01(i,1),:))');
    X_train_tmp01(:,2,1,i) = mat2gray(abs(Bg_var_CIR01)');
end
for  i = 1:trainIDX02
    X_train_tmp02(:,1,1,i) = mat2gray(abs(Dyn_var_CIR02(trainSet02(i,1),:))');
    X_train_tmp02(:,2,1,i) = mat2gray(abs(Bg_var_CIR02)');
end
for  i = 1:trainIDX04
    X_train_tmp04(:,1,1,i) = mat2gray(abs(Dyn_var_CIR04(trainSet04(i,1),:))');
    X_train_tmp04(:,2,1,i) = mat2gray(abs(Bg_var_CIR04)');
end
for  i = 1:trainIDX12
    X_train_tmp12(:,1,1,i) = mat2gray(abs(Dyn_var_CIR12(trainSet12(i,1),:))');
    X_train_tmp12(:,2,1,i) = mat2gray(abs(Bg_var_CIR12)');
end
for  i = 1:trainIDX14
    X_train_tmp14(:,1,1,i) = mat2gray(abs(Dyn_var_CIR14(trainSet14(i,1),:))');
    X_train_tmp14(:,2,1,i) = mat2gray(abs(Bg_var_CIR14)');
end
for  i = 1:trainIDX24
    X_train_tmp24(:,1,1,i) = mat2gray(abs(Dyn_var_CIR24(trainSet24(i,1),:))');
...
%% test
for i = 1:num_tst01
    X_test01(:,1,1,i) = mat2gray(abs(Dyn_var_CIR01(tstSet01(i,1),:))');
    X_test01(:,2,1,i) = mat2gray(abs(Bg_var_CIR01)');
end
for i = 1:num_tst02
    X_test02(:,1,1,i) = mat2gray(abs(Dyn_var_CIR02(tstSet02(i,1),:))');
    X_test02(:,2,1,i) = mat2gray(abs(Bg_var_CIR02)');
end
for i = 1:num_tst04
    X_test04(:,1,1,i) = mat2gray(abs(Dyn_var_CIR04(tstSet04(i,1),:))');
    X_test04(:,2,1,i) = mat2gray(abs(Bg_var_CIR04)');
end
for i = 1:num_tst12
    X_test12(:,1,1,i) = mat2gray(abs(Dyn_var_CIR12(tstSet12(i,1),:))');
    X_test12(:,2,1,i) = mat2gray(abs(Bg_var_CIR12)');
end
for i = 1:num_tst14
    X_test14(:,1,1,i) = mat2gray(abs(Dyn_var_CIR14(tstSet14(i,1),:))');
    X_test14(:,2,1,i) = mat2gray(abs(Bg_var_CIR14)');
end
for i = 1:num_tst24
    X_test24(:,1,1,i) = mat2gray(abs(Dyn_var_CIR24(tstSet24(i,1),:))');
